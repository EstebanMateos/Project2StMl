...
if __name__ == "__main__":
    ...
    D = {}
    D["MC"] = {str(1):0,str(2):0,str(6):0, str(inf):0}
    D["QL_Ext"] = {str(1):0,str(2):0,str(6):0, str(inf):0}
    D["QL_sum"] = {str(1):0,str(2):0,str(6):0, str(inf):0}
    ...
    for decks in [1,2,6,8,inf]:
        ...
        D["MC"][str(decks)] = MC_avg_reward
        D2["MC"][str(decks)] = avg_rewards_over_n_episodes
        ...
        D["QL_Ext"][str(decks)] = avg_reward
        D2["QL_Ext"][str(decks)] = avg_rewards_over_n_episodes
        ...
        D["QL_sum"][str(decks)] = sum_avg_reward
        D2["QL_sum"][str(decks)] = avg_rewards_over_n_episodes
...
print("Average over all episodes : ")
for i in D.keys() :
    print(f"Method {i} :")
    for j in D[i].keys() :
        print(f"\t deck {j} : {D[i][j]}")

print(f"Average over {rl.NbRewardsMeans} episodes (setup in RL.py) : ")
for i in D2.keys() :
    print(f"Method {i} :")
    for j in D2[i].keys() :
